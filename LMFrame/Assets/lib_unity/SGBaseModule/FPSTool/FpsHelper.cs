...
using System.Collections.Generic;using SG.Utils;
using UnityEngine;
...
namespace SG.Utils
{
    ...
    /// 打印FPS
    /// </summary>
    public class FpsHelper : MonoSingleton<FpsHelper>
    {
        ...
        private event Action<string> fpsChange;
        ...
        public void AddChangeEvent(Action<string> e)
        {
            fpsChange += e;
        }
        
        public void RemoveChangeEvent(Action<string> e)
        {
            fpsChange -= e;
        }
