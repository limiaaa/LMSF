...
namespace SG.AssetBundleBrowser.AssetBundlePacker
{
    public static class Common
    {
        ...
        private const string MAINAPP = "mainapp";
        ...
        ///   获得资源全局路径
        /// </summary>
        public static string GetFileFullName(string file, string gamename = MAINAPP)
        {
            return (SG.SettingReader.ScriptableObject.IsNeedHotFix ? PATH : INITIAL_PATH) + "/" +
                   gamename.ToLower() + "/" +
                   file;
        }
        ...
        ///   获得资源原始全局路径
        /// </summary>
        public static string GetInitialFileFullName(string file, string gamename = MAINAPP)
        {
            return INITIAL_PATH + "/" + gamename.ToLower() + "/" + file;
        }

        /// <summary>
        ///   获得缓存路径
        /// </summary>
        public static string GetCacheFileFullName(string file, string gamename = MAINAPP)
        {
            return CACHE_PATH + "/" + gamename.ToLower() + "/" + file;
        }
        ...
        {
            yield return AssetBundleBrowser.FileHelper.CopyStreamingAssetsToFile(str, dest);
        }

        /// <summary>
        ///   拷贝文件
        /// </summary>
        public static IEnumerator StartCopyInitialFile(string local_name, string gameName = MAINAPP)
        {
            gameName = gameName.ToLower();
            yield return AssetBundleBrowser.FileHelper.CopyStreamingAssetsToFile(
                GetInitialFileFullName(local_name, gameName),
                GetFileFullName(local_name, gameName));
        }
        ...
        ///   载入Manifest
        /// </summary>
        public static AssetBundleManifest LoadMainManifest(string gameName = MAINAPP)
        {
            string file = Common.GetFileFullName(Common.MAIN_MANIFEST_FILE_NAME, gameName);
        ...
        ///   载入ResourcesMnifest
        /// </summary>
        public static ResourcesManifest LoadResourcesManifest(string gameName = MAINAPP)
        {
            string file = Common.GetFileFullName(Common.RESOURCES_MANIFEST_FILE_NAME, gameName);
        ...
        ///   载入ResourcesPack
        /// </summary>
        public static ResourcesPackages LoadResourcesPackages(string gameName = MAINAPP)
        {
            string file = Common.GetFileFullName(Common.RESOURCES_PACKAGE_FILE_NAME, gameName);
        ...
        public static AssetBundleManifest LoadMainManifestByPath(string full_name)
        {
            ...
            {
                Debug.LogError("No file exist: " + full_name);
                return null;
            }
        ...
        {
            var result = ResourcesManifest.Load(full_name);
        ...
        public static Func<string, string, string> GetAssetBundleDownloadURLBySubGameFunc;
    }
}