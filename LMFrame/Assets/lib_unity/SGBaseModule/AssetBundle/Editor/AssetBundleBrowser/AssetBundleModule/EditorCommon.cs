...
namespace SG.AssetBundleBrowser.AssetBundlePacker
{
    ...
    public static class EditorCommon
    {
        ...
        ///   编辑器环境下默认打包路径
        /// </summary>
        //public static string BUILD_PATH = System.IO.Directory.GetCurrentDirectory() + "\\" + Common.ROOT_FOLDER_NAME;
        ...
        public static string MAIN_MANIFEST_FILE_PATH
        {
            get {
                return BUILD_PATH + "/" + Common.MAIN_MANIFEST_FILE_NAME;
            }
        }
        ...
        public static string RESOURCES_MANIFEST_FILE_PATH
        {
            get
            {
                return BUILD_PATH + "/" + Common.RESOURCES_MANIFEST_FILE_NAME;
            }
        }
        /// <summary>
        ...
        public static string RESOURCES_PACKAGE_FILE_PATH
        {
            get
            {
                return BUILD_PATH + "/" + Common.RESOURCES_PACKAGE_FILE_NAME;
            }
        }
        /// <summary>
        ///   忽略的文件类型(后缀名)
