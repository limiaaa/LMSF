        ...
        internal class ContentDownload
        {
            ...
            private void OpenFile(bool isNew, bool failedRetry = true)
            {
                try
                {
                    ...
                    {
                        Debug.Log("WebRequestDownload - OpenFile - create new file\n" + tempFileFullName);
                    ...
                    {
                    Debug.Log("WebRequestDownload - OpenFile - read old file\n" + tempFileFullName);
                        //断点续传
            ...
            private bool ReadLastModified(ref DateTime last_modified)
            {
                if (fs != null && fs.Length > FILE_LAST_MODIFIED_SIZE)
                {
                    ...
                    {
                        Debug.Log("WebRequestDownload - ReadLastModified: " + e.Message + "\n" + e.StackTrace);
