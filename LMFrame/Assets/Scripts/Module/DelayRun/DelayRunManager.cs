...
public class DelayRunManager : MonoSingleton<DelayRunManager>
{
   //会随着游戏周期一直迭代，比如体力
    ...
    {
        //long DelyTimerManager = 0;
        ////过去了多久+跑了多久
        //DelyTimerManager = TimeManager.Instance.ThisLoginAndLastExit + LocalDataUtils.GetLocalData("CoinByAdTime", 0);
        //if (LocalDataUtils.GetLocalData("CoinByAdTime", 0) != 0)
        //{
        //    IsCoinByAdColdTime=true;
        //}
        ////如果过去的时间已经过了冷却
        //if(DelyTimerManager>= ConstConfig.CoinTimeCd * 60)
        //{
        ...
        //    }
        //    DelyTimerManager++;
        //    RemindCoinByAdTime = ConstConfig.CoinTimeCd * 60 - DelyTimerManager;
        //    LocalDataFunc.Instance.SetLocalData("CoinByAdTime", (int)DelyTimerManager);
        //    if (DelyTimerManager >= ConstConfig.CoinTimeCd * 60)
        //    {
        //        RemindCoinByAdTime = 0;
        //        DelyTimerManager = 0;
    ...
    private void RecoverReportUserProfileData()
    {
        ...
        //    {
        //        reportCd = 0;
        //        LocalDataMgr.Instance.UserProfileOnDelyTimerManager();
        //    }
        //});
    }
    //**************************************************************检查玩家特殊增益
